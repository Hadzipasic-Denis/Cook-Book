    ...
    ${
      loading
        ...
        <button
          ...
          className="mx-auto px-3 tracking-wide bg-[#1c7dd8] text-white py-1 rounded-lg font-medium hover:bg-[#689F1F] transition-colors duration-300 flex items-center justify-center gap-2 hover:cursor-pointer"
        >
        ...
        <div className="mt-8">
          ...
          {recipes.length === 0 && !loading ? (
            <p className="text-gray-500 text-center">No recipes found yet.</p>
          ) : (
