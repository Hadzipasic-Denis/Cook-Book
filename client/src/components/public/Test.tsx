...
import testImage from  "../../assets/top-view-fried-shrimp-salad-with-lettuce-arugula-orange-tomato.jpg"

const tags = ["Chinese", "Gluten-Free", "Low-Fet"];
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-sm pr-6">
                    Short description of the dish Short description of the dish
                    Short description of the dish Short description of the dish
                    Short description of the dish Short description of the dish
